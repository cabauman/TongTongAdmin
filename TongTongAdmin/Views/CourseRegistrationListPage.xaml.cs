...
namespace TongTongAdmin.Views
{
    ...
    public sealed partial class CourseRegistrationListPage : Page, INotifyPropertyChanged
    {
        ...
        private Task AddCourseDetailsToUser(string courseId)
        {
            ...
            registrant.HasCurrentOrUpcomingCourse = true;

            if(ThisSemesterRadioButton.IsChecked == true)
            {
                registrant.DidRegister = false;
                registrant.CourseType = SelectedRegistration.CourseType;
                registrant.CourseId = courseId;
            }
            else
            {
                registrant.NextSemesterCourseType = SelectedRegistration.CourseType;
                registrant.NextSemesterCourseId = courseId;
            }
